...
RUN \
    ...
    qt6-base qt6-5compat freeglut poppler-data sane-airscan a2jmidid libffado jack-example-tools jack2-dbus jack2-docs realtime-privileges \
    ...
    #--- 추가된 선택적 종속성 (32-bit) ---
    lib32-alsa-plugins lib32-pipewire-jack lib32-pipewire-v4l2 lib32-vulkan-mesa-layers lib32-jack lib32-pipewire lib32-libdecor lib32-vulkan-radeon lib32-vulkan-intel lib32-opencl-rusticl && \
    \
